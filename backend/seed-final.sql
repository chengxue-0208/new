-- VPN Service Database Seed Script - Final Correct Version
-- This script creates sample data for testing
-- UUID fields will be automatically generated by PostgreSQL

-- Insert Subscription Plans
INSERT INTO "subscription_plans" (name, price, "durationDays", "monthlyTraffic", "isActive", "displayOrder", "created_at", "updated_at") VALUES
  ('Monthly Plan', 19.99, 30, 100, true, 1, NOW(), NOW()),
...
-- Insert Users
INSERT INTO users (email, passwordHash, subscriptionStatus, subscriptionPlanId, subscriptionExpiresAt, balance, trafficUsed, trafficLimit, "created_at", "updated_at") VALUES
...
-- Insert Nodes
INSERT INTO nodes (name, region, protocol, address, port, path, serverName, delay, status, isFree, "created_at", "updated_at") VALUES
  ('US-West-1', 'United States', 'tcp', 'us-west-1.vpn.example.com', 443, '/us-west', 'US-West-1', 100, 'ONLINE', true, NOW(), NOW()),
...
INSERT INTO vpn_configurations (userId, nodeId, protocol, address, port, path, serverName, "created_at", "updated_at") VALUES
  ('user-1', 'node-1', 'tcp', 'us-west-1.vpn.example.com', 443, '/us-west', 'US-West-1 Config', NOW(), NOW()),
...
-- Insert Orders
INSERT INTO orders (userId, planId, amount, paymentMethod, status, payUrl, paymentTransactionId, paidAt, "created_at", "updated_at") VALUES
  ('user-1', 'plan-monthly', 19.99, 'alipay', 'COMPLETED', 'pay-url-1', 'txn-1', NOW(), NOW(), NOW()),
...
INSERT INTO user_subscriptions (userId, subscriptionPlanId, pricePaid, status, expiresAt, trafficUsed, trafficLimit, "created_at", "updated_at") VALUES
  ('user-1', 'plan-monthly', 19.99, 'ACTIVE', '2026-07-11', 0, 10240, NOW(), NOW()),
...
INSERT INTO connection_logs (userId, nodeId, connectAt, disconnectAt, duration, traffic, status, "created_at", "updated_at") VALUES
  ('user-1', 'node-1', NOW(), '2026-06-10 10:05:00', 300, 1024, 'CONNECTED', NOW(), NOW()),
  ('user-2', 'node-3', NOW(), '2026-06-09 16:00:00', 1800, 2048, 'CONNECTED', NOW(), NOW()),
  ('user-1', 'node-2', NOW(), NULL, 0, 0, 'CONNECTING', NOW(), NOW());

-- Insert System Logs
INSERT INTO system_logs (level, message, errorCode, userId, ipAddress, "createdAt") VALUES
  ('INFO', 'User login successful', NULL, 'user-1', '192.168.1.100', NOW()),
