...
exports.NodeModule = NodeModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [node_controller_1.NodesController, delay_controller_1.DelayController],
        providers: [node_service_1.NodesService, delay_service_1.DelayService],
        exports: [node_service_1.NodesService, delay_service_1.DelayService],
    })
], NodeModule);
