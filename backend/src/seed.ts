  ...
  try {
    ...
    const nodes = await nodeRepository.save([
      ...
      },
      {
        ...
        region: 'South Korea',
        protocol: 'vless',
        server: 'kr-01.example.com',
        port: 443,
        uuid: '77777777-7777-4777-8777-777777777777',
        security: 'reality',
        sni: 'www.cloudflare.com',
        publicKey: 'kr-01-public-key',
        shortId: 'kr01',
        flow: 'xtls-rprx-vision',
        transport: 'tcp',
        delay: 180,
      ...
      },
      {
        ...
        region: 'Germany',
        protocol: 'vless',
        server: 'de-01.example.com',
        port: 443,
        uuid: '88888888-8888-4888-8888-888888888888',
        security: 'reality',
        sni: 'www.cloudflare.com',
        publicKey: 'de-01-public-key',
        shortId: 'de01',
        flow: 'xtls-rprx-vision',
        transport: 'tcp',
        delay: 300,
